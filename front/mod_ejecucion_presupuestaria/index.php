      ...
      <div class="row ">
        ...
        <div class="col-lg-8">
          <div class="card " style="height: 32vh;">
            <div class="card-body">
              ...
              <div id="chartdiv_gastos" style="width: 100%; height: 24vh;"></div>
        ...
        <script>
          am5.ready(function() {
            ...
            // Simulación de datos recibidos por AJAX
            setTimeout(function() {
              ...
              // Agregar los datos recibidos al gráfico
              nuevosDatos.forEach(dato => {
                addData(dato.fecha, dato.gasto);
              });
            }, 1000); // Simula la recepción de datos después de 1 segundo
