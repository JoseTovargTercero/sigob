          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <button type="button" id="btn-editar" class="m-a text-center btn btn-primary d-inline-flex btn-sm rounded"> <i class="bx bx-dave"></i> &nbsp; Guardar cambios</button>
                </div>
              </div>
            </div>
          </div>
          ...
          success: function(response) {
            ...
            if (response) {
              ...
              for (var i = 0; i < data.length; i++) {
                ...
                $('#table tbody').append('<tr><td>' + nombre + '</td><td>' + tipo_concepto[tipo] + '</td><td>' + cod_partida + '</td><td><a href="#!" class="badge me-2 bg-brand-color-1 text-white f-12" onclick="editar(' + id + ')">Editar</a></td><td><a href="#!" class="badge me-2 bg-brand-color-2 text-white f-12" onclick="eliminar(' + id + ')">Eliminar</a></td></tr>');
              }
            }
          }
        });
