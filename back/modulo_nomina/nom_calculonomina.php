...
";
    ...
    function calculoSalarioBase($conexion, $empleado, $nombre, $identificador, $frecuencia)
    {
        ...
        TIMESTAMPDIFF(YEAR, empleados.fecha_ingreso, CURDATE()) + empleados.otros_anios AS antiguedad
    FROM empleados
    ...
    WHERE empleados.id = ?";
                ...
                $sql = "SELECT empleados.*, cargos_grados.grado,
        TIMESTAMPDIFF(YEAR, empleados.fecha_ingreso, DATE_ADD(CURDATE(), INTERVAL 7 DAY)) + empleados.otros_anios AS antiguedad
    FROM empleados
    LEFT JOIN cargos_grados ON empleados.cod_cargo = cargos_grados.cod_cargo
    WHERE empleados.id = ?";
            } elseif ($semana_mes == 3) {
                ...
                $sql = "SELECT empleados.*, cargos_grados.grado,
        TIMESTAMPDIFF(YEAR, empleados.fecha_ingreso, DATE_ADD(CURDATE(), INTERVAL 14 DAY)) + empleados.otros_anios AS antiguedad
    FROM empleados
    LEFT JOIN cargos_grados ON empleados.cod_cargo = cargos_grados.cod_cargo
    WHERE empleados.id = ?";
            } elseif ($semana_mes == 4) {
                ...
                $sql = "SELECT empleados.*, cargos_grados.grado,
        TIMESTAMPDIFF(YEAR, empleados.fecha_ingreso, DATE_ADD(CURDATE(), INTERVAL 21 DAY)) + empleados.otros_anios AS antiguedad
    FROM empleados
    LEFT JOIN cargos_grados ON empleados.cod_cargo = cargos_grados.cod_cargo
    WHERE empleados.id = ?";
            } else {
                ...
                $sql = "SELECT empleados.*, cargos_grados.grado,
        TIMESTAMPDIFF(YEAR, empleados.fecha_ingreso, DATE_ADD(CURDATE(), INTERVAL 28 DAY)) + empleados.otros_anios AS antiguedad
    FROM empleados
    LEFT JOIN cargos_grados ON empleados.cod_cargo = cargos_grados.cod_cargo
    WHERE empleados.id = ?";
            }
            ...
            if ($identificador == "q1") {
                $sql = "SELECT empleados.*, cargos_grados.grado,
        TIMESTAMPDIFF(YEAR, empleados.fecha_ingreso, DATE_ADD(CURDATE(), INTERVAL 15 DAY)) + empleados.otros_anios AS antiguedad
    FROM empleados
    LEFT JOIN cargos_grados ON empleados.cod_cargo = cargos_grados.cod_cargo
    WHERE empleados.id = ?";
            } elseif ($identificador == "q2") {
                $sql = "SELECT empleados.*, cargos_grados.grado,
        TIMESTAMPDIFF(YEAR, empleados.fecha_ingreso, DATE_ADD(CURDATE(), INTERVAL 30 DAY)) + empleados.otros_anios AS antiguedad
    FROM empleados
    LEFT JOIN cargos_grados ON empleados.cod_cargo = cargos_grados.cod_cargo
    WHERE empleados.id = ?";
            }
