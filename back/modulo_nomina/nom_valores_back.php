...
if (isset($_POST["tabla"])) {
    ...
    $columnas_sistema = ["id", "nacionalidad", "cedula", "nombres", "otros_anios", "status", "observacion", "cod_cargo", "banco", "cuenta_bancaria", "hijos", "instruccion_academica", "discapacidades", "tipo_nomina", "id_dependencia", "verificado", "correcion", "beca", "fecha_ingreso", "id_categoria", "id_partida"];
