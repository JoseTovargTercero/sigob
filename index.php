          ...
          <div class="card mb-0">
            <form action="back/global/login_validate.php" id="formLogin" method="POST" class="card-body">
              ...
              <div class="form-group mb-3">
                <input value="corro@correo.com" type="email" name="email" class="form-control" placeholder="Correo Electrónico">
              </div>
              <div class="form-group mb-3">
              ...
              <div class="d-flex mt-1 justify-content-between align-items-center">
                ...
                <a href="" class="text-secondary f-w-400 mb-0">Olvidó su contraseña?</a>
              </div>
